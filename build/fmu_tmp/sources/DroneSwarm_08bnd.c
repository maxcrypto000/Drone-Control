...
int DroneSwarm_updateBoundVariableAttributes(DATA *data, threadData_t *threadData)
{
  ...
  DroneSwarm_eqFunction_1154(data, threadData);
  DroneSwarm_eqFunction_1155(data, threadData);
  DroneSwarm_eqFunction_1156(data, threadData);
  DroneSwarm_eqFunction_1157(data, threadData);
  DroneSwarm_eqFunction_1158(data, threadData);
  DroneSwarm_eqFunction_1159(data, threadData);
  DroneSwarm_eqFunction_1160(data, threadData);
  DroneSwarm_eqFunction_1161(data, threadData);
  DroneSwarm_eqFunction_1162(data, threadData);
  DroneSwarm_eqFunction_1163(data, threadData);
  DroneSwarm_eqFunction_1164(data, threadData);
  DroneSwarm_eqFunction_1165(data, threadData);
  messageClose(OMC_LOG_INIT);
